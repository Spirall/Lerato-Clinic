...
date_default_timezone_set('Africa/Johannesburg');
    ...
    <body>
        <div class ="jumbotron" style="margin-top: -15px;">
            <form action="SickNoteReport.php" target="_blank" method="POST">
            <div class="row">
                <div class="col-lg-1">                       
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <p></p>
                    <a href="TerminateConsultation.php">
                            <button type="button" name= "convert" class="btn btn-default form-control">
                                Finish Consultation
                            </button>
                    </a>
                </div>
